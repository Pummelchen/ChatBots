// ChatBotsAppTests — what the app tells a user about where the models run.
//
...
@Suite("Where the app says the models run")
struct UserFacingModelTextTests {
    ...
    func noStringClaimsInProcess() throws {
        ...
        let files = [
            ...
            "Sources/ChatBotsCore/Room/ChatModels.swift": "the backend's own documentation",
        ]
