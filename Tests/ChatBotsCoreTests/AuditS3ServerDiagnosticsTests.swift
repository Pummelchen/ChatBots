...
// the readiness signal that existed, `seatCount`, was read by nobody (A152). A seat count cannot answer
...
/// be indistinguishable from a healthy engine (A152).
...
@MainActor
@Suite("A listener says whether it can serve, not just that it is listening (A152)")
