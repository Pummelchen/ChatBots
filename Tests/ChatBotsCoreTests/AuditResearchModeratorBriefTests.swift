// ChatBotsCoreTests — A70: the opening brief describes the moderator the room actually has
//
...
@Suite("The moderator's brief uses the room's own mode (A70)")
struct AuditResearchModeratorBriefTests {
