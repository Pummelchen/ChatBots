// ChatBotsCoreTests — a connect that fails leaves no session behind
//
...
struct TransportLifecycleTests {
    ...
    /// The observable half of the defect: a client that has a session and is asked to connect again
