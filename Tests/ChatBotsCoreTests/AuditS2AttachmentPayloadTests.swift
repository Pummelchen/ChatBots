// ChatBotsCoreTests — what a snapshot does and does not carry (A144, A214)
//
...
//     (A144), up to 24 files of up to 64 MB each; and
...
//     is dropped and the client keeps the previous state (A214).
//
...
@MainActor
@Suite("An attachment in the snapshot (A144, A214)")
