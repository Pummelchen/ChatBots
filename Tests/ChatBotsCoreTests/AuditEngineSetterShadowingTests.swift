// ChatBotsCoreTests — A115: a setter awaited on the *concrete* engine type
//
...
// implementations are reached. The defect is one type annotation away, and it is the A51/A92 class —
// a control that is presented as working and is not. `AuditFinalTurnLoopTests.liveConfiguration`
