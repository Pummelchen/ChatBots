// ChatBotsCoreTests — the reasoning ceiling must accumulate the way a real stream arrives
//
...
@Suite("The reasoning ceiling accumulates short segments")
struct ReasoningCeilingTests {
