// ChatBotsCoreTests — A73: the search budget counts the calls a turn actually made
//
...
@Suite("The search budget counts real tool calls (A73)")
@MainActor
struct AuditResearchSearchBudgetTests {
