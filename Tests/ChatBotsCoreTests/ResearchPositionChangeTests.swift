// ChatBotsCoreTests — a position change is progress, not silence
//
...
@Suite("A revision is read as a position change")
struct ResearchPositionChangeTests {
...
@Suite("A room that keeps revising its position has not converged")
@MainActor
struct ResearchPositionChangeEngineTests {
