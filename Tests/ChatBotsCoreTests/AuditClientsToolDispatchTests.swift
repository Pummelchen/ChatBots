// ChatBotsCoreTests — a turn can only run the tools its caller offered (audit A104)
//
...
@Suite("A turn runs only the tools its caller offered (audit A104)")
struct AuditClientsToolDispatchTests {
