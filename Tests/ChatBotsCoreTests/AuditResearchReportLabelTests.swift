// ChatBotsCoreTests — A72: a mostly-unlabelled report is not called labelled or traceable
//
...
@Suite("Unlabelled claims are counted against the report (A72)")
struct AuditResearchReportLabelTests {
