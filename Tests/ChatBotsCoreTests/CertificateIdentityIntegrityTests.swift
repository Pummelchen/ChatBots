// ChatBotsCoreTests — the stored TLS identity is read, not assumed.
//
...
@Suite("The stored certificate is read, not assumed")
struct CertificateIdentityIntegrityTests {
...
@MainActor
@Suite("A larger identity reaches a real client", .serialized, TransportSerialized())
struct CertificateTransportTests {
