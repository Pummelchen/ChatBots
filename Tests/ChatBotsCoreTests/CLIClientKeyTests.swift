// ChatBotsCoreTests — a typed key is normalised like the file and environment ones
//
// One `BuiltInKeys.normalisedKey` serves the file and environment paths, and its
...
@Suite("A typed key is normalised like every other key")
struct CLIClientKeyTests {
