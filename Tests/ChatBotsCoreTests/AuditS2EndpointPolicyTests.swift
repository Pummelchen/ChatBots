// ChatBotsCoreTests — where a configured endpoint may point (A141).
//
// A seat's base URL is configuration, and before A136 any web page could set it. It went into
...
@Suite("A configured endpoint is checked before anything is sent to it (A141)")
