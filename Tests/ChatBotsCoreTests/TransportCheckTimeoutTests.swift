// ChatBotsCoreTests — the transport check's timeout is real
//
...
@Suite("The transport check obeys its timeout")
struct TransportCheckTimeoutTests {
    ...
    func hugeBudgetsAreClamped() {
        ...
        // fit — the shape of a parse that kills the process instead of reporting.
    ...
    func oneConnectAttemptCannotSpendTheWholeRun() {
        ...
        // single attempt that began before the listener existed.
