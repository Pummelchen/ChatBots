// ChatBotsCoreTests — A69: the system role is for instructions, not for peer text
//
...
@Suite("Peer text stays out of the system role (A69)")
struct AuditWave2PromptTrustBoundaryTests {
