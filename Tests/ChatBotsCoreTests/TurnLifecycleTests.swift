// ChatBotsCoreTests — the engine's live view is the authority on a turn ending
//
...
struct TurnLifecycleTests {
    ...
    func liveViewClearsWhenTheTurnEnds() async {
        ...
        // The bug this records: nothing ever cleared this, so the pane stayed "generating…"
