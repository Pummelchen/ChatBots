// ChatBotsCoreTests — A90: the public cap and the engine's cap are one answer
//
// A43 fixed the engine's headroom arithmetic in
...
@Suite("The generation cap agrees with the engine (A90)")
struct AuditWave2GenerationCapTests {
