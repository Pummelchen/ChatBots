// ChatBotsCoreTests — a share page carries no origin from the request (A217, and A99 before it)
//
// A99 gave the share page the origin it was reached on: the request's `Host` was checked by
...
// gone (A217), and what A99's feature actually needs still works: the link a reader copies is built by
...
// is not something `URLSession` will let a test choose (`RawConnection`, A151).
...
@MainActor
@Suite("A share page carries no origin from the request (A217)")
