// ChatBotsCoreTests — A136: a state-changing request must be same-origin JSON
//
...
@Suite("A state-changing request must be same-origin JSON (A136)")
@MainActor
struct AuditS0CrossOriginTests {
