// ChatBotsCoreTests — a failure has to say what went wrong
//
...
// rejected sat unread in the error's own `description`. Finding the cause took a debugging
...
@Suite("A transport failure says what it was")
