// ChatBotsCoreTests — a truncated stream is not a finished turn
//
...
struct ClientsStreamTests {
    ...
    /// turn rather than a finished one.
    ...
    /// `record(.turnFinished)` cleared the failure it had just been handed.
