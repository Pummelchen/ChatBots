// ChatBotsCoreTests — snapshots are ordered by a revision, not by the wall clock
//
// The earlier guard ordered snapshots by `serverTime`, which `ProtocolCodec` encodes ISO-8601 and is
...
@Suite("Snapshot ordering uses a monotonic revision")
@MainActor
struct SnapshotRevisionTests {
