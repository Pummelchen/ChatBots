// ChatBotsCoreTests — an unobserved event stream must not grow without bound
//
...
/// against an expected 256. Reading until nothing new has arrived for a quiet period is a
...
struct EngineStateEventStreamTests {
