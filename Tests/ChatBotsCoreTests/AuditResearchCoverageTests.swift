// ChatBotsCoreTests — A95: coverage is engagement, not a sentence containing the subject
//
// A67 raised the bar usefully: coverage needed a contribution that gave a basis, and a marker
...
@Suite("Coverage requires the room's engagement (A95)")
@MainActor
struct AuditResearchCoverageTests {
