// ChatBotsCoreTests — A46: a rebuilt document carries the engine's own figures
//
...
// reported "0 words" — or "Zero bytes" for an image — on every chip (audit A46). The engine's
...
struct AuditApp2AttachmentSummaryTests {
    ...
    func olderPayloadStillDecodes() throws {
        // The shape the app persisted before A46, with the two new keys absent. If this threw,
