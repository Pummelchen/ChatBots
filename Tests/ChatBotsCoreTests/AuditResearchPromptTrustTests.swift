// ChatBotsCoreTests — A103: the moderator's topic and source material are not system-role text
//
...
// read as system-role instruction to every seat in the room. A69 drew the same boundary for
...
@Suite("The topic and source material are user-role data (A103)")
struct AuditResearchPromptTrustTests {
