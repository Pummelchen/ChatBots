...
public enum SocialLibrary {
    ...
    private static let alpha = SocialCharacter(
    ...
    private static let villain = SocialCharacter(
    ...
    private static let contrarian = SocialCharacter(
    ...
    private static let hothead = SocialCharacter(
    ...
    private static let schemer = SocialCharacter(
    ...
    private static let manipulator = SocialCharacter(
    ...
    private static let diva = SocialCharacter(
    ...
    private static let instigator = SocialCharacter(
    ...
    private static let jealous = SocialCharacter(
    ...
    private static let grudge = SocialCharacter(
    ...
    private static let flirt = SocialCharacter(
    ...
    private static let romantic = SocialCharacter(
    ...
    private static let heartbreaker = SocialCharacter(
    ...
    private static let jealousLover = SocialCharacter(
    ...
    private static let bestFriend = SocialCharacter(
    ...
    private static let gossip = SocialCharacter(
    ...
    private static let peacemaker = SocialCharacter(
    ...
    private static let fakeNice = SocialCharacter(
    ...
    private static let scientist = SocialCharacter(
    ...
    private static let philosopher = SocialCharacter(
    ...
    private static let lawyer = SocialCharacter(
    ...
    private static let factChecker = SocialCharacter(
    ...
    private static let skeptic = SocialCharacter(
    ...
    private static let conspiracy = SocialCharacter(
    ...
    private static let pragmatist = SocialCharacter(
    ...
    private static let idealist = SocialCharacter(
    ...
    private static let comedian = SocialCharacter(
    ...
    private static let troll = SocialCharacter(
    ...
    private static let chaos = SocialCharacter(
    ...
    private static let storyteller = SocialCharacter(
    ...
    private static let deadpan = SocialCharacter(
    ...
    private static let underdog = SocialCharacter(
    ...
    private static let perfectionist = SocialCharacter(
    ...
    private static let hustler = SocialCharacter(
    ...
    private static let survivor = SocialCharacter(
    ...
    private static let overachiever = SocialCharacter(
