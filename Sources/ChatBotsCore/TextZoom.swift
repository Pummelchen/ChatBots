...
// them against themselves, which pinned nothing — changing the store left it green (A167, and A166
// for why it had to be written that way).
...
public enum TextZoom {
    ...
    /// caller would see if that ever stopped being true, rather than a trap (audit A28).
