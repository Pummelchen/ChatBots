...
public struct ModeratorIdentity: Sendable, Hashable, Codable {
    ...
    /// reality-show character they never chose, in the opening brief every analyst reads. An
    /// identifier that is not in this mode's library means the moderator has no persona
