...
public enum SampleConversation {
    ...
    public static func turns(topic: String) -> [Turn] {
        ...
        return [
            Turn(sequence: next(), speakerName: "Moderator", kind: .topic,
                 content: topic, timestamp: at(0)),

            Turn(sequence: next(), speakerID: "Agent 1", speakerName: "Agent 1", kind: .chat,
                 content: """
            ...
            Turn(sequence: next(), speakerID: "Agent 2", speakerName: "Agent 2", kind: .chat,
                 content: """
            ...
            Turn(sequence: next(), speakerID: "Agent 1", speakerName: "Agent 1", kind: .tool,
                 content: "web_search: 5 result(s) for \"egg shape oviduct membrane\"",
                 timestamp: at(120)),

            Turn(sequence: next(), speakerName: "Moderator", kind: .steering,
