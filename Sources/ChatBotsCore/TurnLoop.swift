...
//
// A02 measured `MLXEngine.swift` at 2.2 % line coverage and the reason is structural: the
...
extension MLXEngine {
    ...
    /// it is exercised with a stub stream rather than only with weights (audit A02).
    ///
