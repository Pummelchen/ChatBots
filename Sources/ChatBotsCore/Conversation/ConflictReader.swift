...
public enum ConflictReader {
    ...
    /// landed on whoever spoke last instead of on Otto.
    ...
    /// because that is what the social state is keyed by.
    ...
    public static func namedTarget(in lowered: String, others: [String]) -> String? {
        ...
        // strings it is handed rather than a name-to-id map.
...
extension ConflictReader {
    ...
    public static func summary(of text: String) -> String? {
        ...
        let firstSentence =
            cleaned.split(whereSeparator: { $0 == "." || $0 == "!" || $0 == "?" })
